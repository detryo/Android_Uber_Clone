...
import cristian_sedano.uberclone.Common.Common;
        ...
        LocationListener
{
    ...
    private Marker carMarker; // change !!!
    private float v;
   ...
   // private Button btnGo;
        ...
        public void run() {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    lag = v*endPosition.longitude+(1 -v)*startPosition.longitude;
                    lat = v*endPosition.latitude+(1 -v)*startPosition.latitude;
                    LatLng newPos = new LatLng(lat, lag);
    ...
    private float getBearing(LatLng startPosition, LatLng endPosition) {
        ...
        double log = Math.abs(startPosition.longitude - endPosition.longitude);

        if (startPosition.latitude < endPosition.latitude && startPosition.longitude < endPosition.longitude)
            return (float) (Math.toDegrees(Math.atan(log/lat)));
        else if (startPosition.latitude >= endPosition.latitude && startPosition.longitude < endPosition.longitude)
            return (float) ((90 - Math.toDegrees(Math.atan(log/lat))) * 90);
        else if (startPosition.latitude >= endPosition.latitude && startPosition.longitude >= endPosition.longitude)
            return (float) (Math.toDegrees(Math.atan(log/lat)) + 180);
        else if (startPosition.latitude < endPosition.latitude && startPosition.longitude >= endPosition.longitude)
            return (float) ((90 - Math.toDegrees(Math.atan(log/lat)))+ 270);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        places.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                {
                    Toast.makeText(Welcome.this, "Place change your status to ONLINE", Toast.LENGTH_SHORT).show();
                }
            }
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    try {
                        ...
                        carMarker = mMap.addMarker(new MarkerOptions()
                                ...
                                .flat(true)
                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.car))); // change image, we need Horizontal
    ...
    // This method we can get from Internet
